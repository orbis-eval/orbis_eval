cd ..
git clone https://github.com/orbis-eval/orbis_addon_repoman.git
...
git clone https://github.com/orbis-eval/orbis_plugin_evaluation_binary_classification_evaluation.git
git clone https://github.com/orbis-eval/orbis_plugin_storage_csv_result_list.git
git clone https://github.com/orbis-eval/orbis_plugin_storage_html_pages.git